                ...
                <table cellpadding="0" cellspacing="0">
                   <table cellpadding="0" cellspacing="0">
                      <tr class="information">
                         <td colspan="10">
                            <table>
                              ...
                              <tr>
                              <td style="text-align: left;">
                                 Credit note for month of: ${datas.fromM} ${datas.year}
                              </td>
                           </tr>
                            </table>
                         </td>
                     ...
                     <tr>
                        ...
                        <td></td>
                        <td style="text-align: center; border-bottom: 1px solid #eee;"><strong style="font-size: 10px;">USD ${Intl.NumberFormat('en-US').format(
                          total * 1.0)
                        }</strong></td>      
                     </tr>
                   </table>
                   ${
                     datas.client[0].deduct_broker_comms
                       ? `Net outstanding shall be deducted from the clearing account ${datas.client[0].deduct_broker_comms} held with BPI</p>`
                       : `<br />`
                   }
