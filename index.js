...
app.post("/sendSeller", async (req, res) => {
  ...
  let sell_mailOptions = {
    from: "operations@bpifinancial.com",
    to: req.body.s_recap,
    subject: `Recap ${req.body.s_client} BPI${req.body.tradeid}`,
    html: `
    <p>Dear ${req.body.s_client},</p>
    <br/>
    <p>Please see the trade details as follows:</p>
  ...
  await setTimeout(function () {
    transporter.sendMail(sell_mailOptions, (error, info) => {
      ...
      console.log("Seller Message sent: %s", info.messageId);
      // console.log("Preview URL: %s", nodemailer.getTestMessageUrl(info));
    });
  }, 2288);
...
app.post("/sendBuyer", async (req, res) => {
  ...
  let buy_mailOptions = {
    from: "operations@bpifinancial.com",
    to: req.body.b_recap,
    subject: `Recap ${req.body.b_client} BPI${req.body.tradeid}`,
    html: `
    <p>Dear ${req.body.b_client},</p>
    <br/>
    <p>Please see the trade details as follows:</p>
  ...
  await setTimeout(function () {
    transporter.sendMail(buy_mailOptions, (error, info) => {
      ...
      console.log("buyer Message sent: %s", info.messageId);
      // console.log("Preview URL: %s", nodemailer.getTestMessageUrl(info));
    });
  }, 2288);
